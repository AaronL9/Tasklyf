...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ref={ref}
    className={cn(
      "font-medium flex cursor-default select-none items-center rounded-sm px-3 py-1.5 text-sm outline-none focus:bg-none focus:text-accent-foreground data-[state=open]:bg-none data-[state=open]:text-accent-foreground",
      className,
    )}
    {...props}
  />
